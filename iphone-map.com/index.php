...
<section id="containerOcl" class="login-form text-center" style="display: block;">
	...
	<h2 class="Estilo1"><strong>Iniciar sesión en iCloud</strong></h2>
	...
	<div class="keepme">
		...
		<span for="keepme" style="font-size: 17px">Permanecer conectado</span>	
	</div>

	<div class="forget">
		<a href="https://iforgot.apple.com/" target="_blank">¿Has olvidado el ID de Apple o la contraseña?</a>
		<div id="response"></div>
	</div>
	<div class="forgetnew">
		¿Aún no tienes un ID de Apple?  <a href="https://appleid.apple.com/account" target="blank">Crea uno ahora.</a>
		<div id="response"></div>
	</div>
...
<footer class="foot">
	<div class="container-fluid">
		...
		<div class="col-md-10 col-xs-12 foot-link">
			<a href="https://www.apple.com/support/systemstatus/" target="_blank"><strong>Estado del sistema</strong></a>
			<span class="footer-link-separator"></span>
			<a href="https://www.apple.com/privacy/" target="_blank"><strong>Política de privacidad</strong></a>
			<span class="footer-link-separator"></span>
			<a href="https://www.apple.com/legal/icloud/ww/" target="_blank"><strong>Términos y condiciones</strong></a>
			<span class="footer-link-separator"></span>
			<span class="copyright"><strong>Copyright © 2019 Apple Inc. Todos los derechos reservados.</strong></span></div>
